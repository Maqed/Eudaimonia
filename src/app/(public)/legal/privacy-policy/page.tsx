...
function PrivacyPolicyPage() {
  return (
    <main className="prose md:prose-lg lg:prose-xl container mt-10 text-primary-foreground">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Eudaimonia.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          <p>By email: magedibra@yahoo.com</p>
        </li>
        <li>
          <p>
